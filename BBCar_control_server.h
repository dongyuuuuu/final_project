...
private:
    /*! @brief Server shim for Speed of BBCarService interface. */
    erpc_status_t Speed_shim(erpc::Codec * codec, erpc::MessageBufferFactory *messageFactory, uint32_t sequence);

    /*! @brief Server shim for distance of BBCarService interface. */
    erpc_status_t distance_shim(erpc::Codec * codec, erpc::MessageBufferFactory *messageFactory, uint32_t sequence);
};
